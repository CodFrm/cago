...
func (c *Cmd) writeGoDoc(packageName string, output io.Writer, swagger *spec.Swagger) error {
	...
	code := c.formatSource(buffer.Bytes())
...
func (c *Cmd) formatSource(src []byte) []byte {
